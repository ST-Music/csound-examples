...
; p4  = pitch (including detune [5-voice "unison"] <CsoundSynthesizer>
<CsOptions>
 -o dac   -d -m2
 -o strings.wav
</CsOptions>
...
aMix1 = dcblock2(aRamp * (aPwm1 + .7) + (aPwm1 -.7), 256)
aMix2 = dcblock2(aRmp2 * (aPwm2 + .3) + (aPwm2 -.3), 256)
kQ    = adsr(.06, 4.358, .08, .06)/2
a1,a12,a18,a24 mvclpf4 aMix1 * p5 * aEnv, 4000, .1
a2,a12,a18,a24 mvclpf4 aMix2 * p5 * aEnv, 4000, .1
